...
IUSE="+closure-compile component-build cups cpu_flags_arm_neon +hangouts headless kerberos +openh264 ozone pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu +system-libvpx +tcmalloc vaapi v4l2m2m wayland widevine"
...
src_configure() {
	...
	myconf_gn+=" use_v4l2_codec=$(usex v4l2m2m true false)"
