...
SRC_URI="amd64? (
		...
		arm64? (
			https://static.rust-lang.org/dist/rustc-${STAGE0_VERSION}-aarch64-unknown-linux-gnu.tar.gz
			https://static.rust-lang.org/dist/rust-std-${STAGE0_VERSION}-aarch64-unknown-linux-gnu.tar.gz
			https://static.rust-lang.org/dist/cargo-${STAGE0_VERSION_CARGO}-aarch64-unknown-linux-gnu.tar.gz
		)
		x86? (
