...
RDEPEND="
	...
	>=sys-apps/rpi3-init-scripts-1.1.3
	...
	core? (
		>=app-admin/logrotate-3.12.3
		>=app-admin/sudo-1.8.20_p2
		>=app-admin/syslog-ng-3.7.3
		>=app-arch/lzop-1.03
		>=app-crypt/gnupg-2.1.21-r1
		>=app-editors/nano-2.8.6
		...
		>=net-analyzer/nmap-7.50
		>=net-analyzer/tcpdump-4.9.1
		>=net-irc/irssi-1.0.4
		>=net-misc/bridge-utils-1.5
		>=net-misc/chrony-3.1-r1
		...
		>=sys-fs/btrfs-progs-4.11
		>=sys-fs/dosfstools-4.1
		>=sys-fs/eudev-3.2.2-r1
		>=sys-fs/fuse-2.9.7
		>=sys-fs/multipath-tools-0.6.4
	...
	apps? (
		...
		>=mail-client/claws-mail-3.15.0
		>=mail-client/thunderbird-52.2.0
		>=media-gfx/gimp-2.9.4-r3
		>=media-gfx/ristretto-0.8.2
		>=media-video/mplayer-1.3.0-r1
		>=media-video/smplayer-16.11.0
		>=media-video/vlc-2.2.6-r1
