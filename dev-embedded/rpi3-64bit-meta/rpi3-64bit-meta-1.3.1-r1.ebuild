...
RDEPEND="
	...
	core? (
		...
		>=app-admin/syslog-ng-3.18.1
		>=app-arch/lzop-1.04
		>=app-crypt/gnupg-2.2.11
		...
		>=net-misc/networkmanager-openvpn-1.8.8
		>=net-misc/rpi3-ethfix-1.0.0-r1
		>=net-vpn/openvpn-2.4.6
		>=net-wireless/iw-4.14
		|| ( >=sys-apps/util-linux-2.33 >=net-wireless/rfkill-0.5-r1 )
		...
		>=sys-apps/rpi3-expand-swap-1.0-r3
		...
		>=sys-fs/eudev-3.2.7
		>=sys-fs/f2fs-tools-1.12.0
		>=sys-fs/fuse-2.9.8
		>=sys-fs/multipath-tools-0.7.9
	...
	apps? (
		...
		>=app-office/libreoffice-6.1.3.2
		>=app-office/libreoffice-l10n-6.1.3.2
		>=app-portage/porthole-0.6.1-r6
		>=app-text/evince-3.28.5
		>=dev-util/meld-3.18.3
