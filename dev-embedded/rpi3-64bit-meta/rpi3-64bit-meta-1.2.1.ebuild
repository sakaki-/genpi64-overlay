...
RDEPEND="
	...
	core? (
		...
		>=app-arch/lzop-1.04
		>=app-crypt/gnupg-2.2.5-r1
		>=app-editors/nano-2.9.5
		>=app-editors/vim-8.0.1645
		>=app-editors/vim-core-8.0.1645
		...
		>=net-misc/chrony-3.3_pre1
		>=net-misc/dhcpcd-7.0.2
		>=net-misc/iperf-3.5
		>=net-misc/keychain-2.8.5
		>=net-misc/networkmanager-1.10.2
		>=net-misc/networkmanager-openvpn-1.8.2
		>=net-vpn/openvpn-2.4.5
		>=net-wireless/iw-4.14
		|| ( >=sys-apps/util-linux-2.32 >=net-wireless/rfkill-0.5-r1 )
	...
	xfce? (
		...
		>=x11-misc/lightdm-1.26.0
		>=x11-misc/lightdm-gtk-greeter-2.0.5
		>=x11-misc/rpi3-safecursor-1.0.1
		>=x11-misc/twofing-0.1.2-r2
		>=x11-misc/xdiskusage-1.51
		>=x11-terms/xfce4-terminal-0.8.7.3
		>=x11-terms/xterm-331
	...
	apps? (
		...
		>=app-editors/emacs-25.3-r4
		>=app-editors/mousepad-0.4.0-r1
		>=app-office/libreoffice-6.0.2.1
		>=app-office/libreoffice-l10n-6.0.2.1
		>=app-portage/porthole-0.6.1-r5
		...
		>=media-video/mplayer-1.3.0-r4
		>=media-video/smplayer-18.3.0
		...
		>=www-client/links-2.14-r1
		>=x11-plugins/enigmail-2.0
		dev-java/icedtea:8
	)
"
