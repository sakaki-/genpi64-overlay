...
RDEPEND="
	...
	kernel-bin? (
		boot-fw? (
			|| (
				>=sys-kernel/bcmrpi3-kernel-bin-4.19.25.20190226[with-matching-boot-fw(-),pitop(-)?]
				>=sys-kernel/bcmrpi3-kernel-bis-bin-4.19.25.20190226[with-matching-boot-fw(-),pitop(-)?]
			)
		)
		!boot-fw? (
			|| (
				>=sys-kernel/bcmrpi3-kernel-bin-4.19.25.20190226[-with-matching-boot-fw(-)]
				>=sys-kernel/bcmrpi3-kernel-bis-bin-4.19.25.20190226[-with-matching-boot-fw(-)]
			)
		)
	)
	!kernel-bin? (
		boot-fw? (
			>=sys-boot/rpi3-64bit-firmware-1.20190215[pitop(-)?,dtbo(+)]
		)
		!boot-fw? (
	...
	core? (
		...
		>=net-misc/networkmanager-openvpn-1.8.10
		>=net-misc/rpi3-ethfix-1.0.0-r1
		>=net-vpn/openvpn-2.4.6-r1
		>=net-wireless/iw-5.0.1
		|| ( >=sys-apps/util-linux-2.33.1 >=net-wireless/rfkill-0.5-r1 )
		>=net-wireless/rpi3-wifi-regdom-1.0
		>=net-wireless/wireless-tools-30_pre9
		>=net-wireless/wpa_supplicant-2.7-r1
		>=sys-apps/ack-2.24
		...
		>=sys-devel/distcc-3.3.2-r4
		>=sys-fs/btrfs-progs-4.20.1
		>=sys-fs/dosfstools-4.1
		>=sys-fs/eudev-3.2.7-r1
	...
	xfce? (
		...
		>=media-libs/mesa-19.0.0_rc4
		>=media-tv/v4l-utils-1.14.1
		...
		>=sys-apps/pyconfig_gen-1.0.1-r2
		...
		>=xfce-extra/thunar-volman-0.9.1
	...
	apps? (
		...
		>=media-sound/mpd-0.21.4-r1
		>=media-tv/kodi-18.0
		>=media-video/mplayer-1.3.0-r5
		>=media-video/smplayer-19.1.0
		>=media-video/vlc-3.0.6
