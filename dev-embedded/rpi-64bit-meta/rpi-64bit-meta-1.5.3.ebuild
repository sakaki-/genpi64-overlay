...
RDEPEND="
	...
	innercore? (
		...
		>=net-wireless/iw-5.4
		|| ( >=sys-apps/util-linux-2.34-r3 >=net-wireless/rfkill-0.5-r1 )
	...
	xfce? (
		...
		>=media-libs/mesa-19.2.4-r1[rpi-v3d(-)]
		>=media-sound/pavucontrol-4.0
		>=media-tv/v4l-utils-1.16.6
		>=media-video/ffmpeg-4.2.1-r3[v4l2m2m-fix(-)]
