...
RDEPEND="
	...
	innercore? (
		...
		>=dev-vcs/git-2.24.0
		>=media-libs/raspberrypi-userland-1.20191121-r1
		>=media-sound/alsa-tools-1.1.7
		>=media-sound/alsa-utils-1.1.9
		...
		>=sys-apps/rpi-onetime-startup-1.0-r3
		>=sys-apps/rpi-serial-1.0.0
		>=sys-apps/rpi-spi-1.0.0-r1
	...
	xfce? (
		...
		>=media-libs/mesa-19.3.0_rc3-r1[rpi-v3d(-)]
